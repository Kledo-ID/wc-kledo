			...
			<div class="wc-kledo-support">
				...
				<p>
					<span class="wc-kledo-support-title">
						<i class="fa fa-envelope" aria-hidden="true"></i>&nbsp; <a href="https://api.whatsapp.com/send?phone=6282383334000" target="_blank">
							<?php _e( 'Request Support', WC_KLEDO_TEXT_DOMAIN ); ?>
						</a>
					</span>
